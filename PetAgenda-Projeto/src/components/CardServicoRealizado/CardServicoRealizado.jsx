  ...
  return (
    <>
        <tr>
            ...
            <td><div>{servicoRealizado.inicio && servicoRealizado.inicio.replace(/ \d\d:\d\d:\d\d/, '')}</div><br></br>~2 meses</td>
            <td>{servicoRealizado.inicio && servicoRealizado.inicio.replace(/\d{4}-\d{2}-\d{2} /, '')}</td>
            <td>{servicoRealizado.fim && servicoRealizado.fim.replace(/\d{4}-\d{2}-\d{2} /, '')}</td>
