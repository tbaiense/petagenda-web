...
const PetServicoCard = ({ ...props }) => {
  ...
  return (
    <Accordion.Item
      className="pet-servico-card-item "
      eventKey={props.pet.id}
      key={props.pet.id}
    >
      {/* Título de pet */}
      <Card.Header>
        <Stack direction="horizontal" gap={3}>
          <h4 className="me-auto">{props.pet.nome}</h4>
          <span
            style={{
              fontSize: "1.0em",
          ...
          <Button
            onClick={(e) => {
              props.setPetList(
                props.petList.filter((p) => p.id != props.pet.id)
              );
            }}
          >
            ✕
          ...
          >
            <div>
              <FloatingLabel
                ...
                label="Instruções de alimentação"
              >
                <Form.Control
                  as="textarea"
            ...
            <Col>
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  type="text"
                  placeholder="Dipirona monohidratada..."
                  id="nome-remedio"
                />
              </Form.Group>
            </Col>
            <Col>
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  type="text"
                  placeholder="Administrar duas vezes ao dia..."
                  id="instrucoes-remedio"
                />
              </Form.Group>
            </Col>
            <Col>
              <Button
                ...
                onClick={(e) => {
                  const rem = {
                    ...
                    instrucoes:
                      document.getElementById("instrucoes-remedio").value,
                  };
                      ...
                      <Button
                        onClick={(e) => {
                          if (props.pet.remedios.length != 0) {
                            props.pet.remedios = props.pet.remedios.flatMap(
                              (rem) => (rem.id == r.id ? [] : rem)
                            );
