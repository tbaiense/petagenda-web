...
const ListarClientes = () => {
  ...
  async function popularListaClientes() {
    ...
    setPesquisando(true);
    empresaFetch(
      `/cliente?query=${searchQuery}&option=${tipoFiltro}&ordenacao=${ordenacao}`
    )
      .then((res) => res.json())
      .then((data) => {
                  ...
                  <div className={styles.position2}>
                    <div className={styles.alinhamentoImage}>
                      <img
                        src={iconEditar}
                        alt=""
                        onClick={() => navEditarCliente(cliente)}
                      />
                    </div>
                    <div className={styles.alinhamentoImage}>
                      <img
                        ...
                        onClick={() => {
                          if (
                            confirm("Deseja realmente deletar este cliente?")
                          ) {
          ...
          <Modal.Body>
            <div className={styles.estiloModal}>
              ...
              <div>
                ...
                {clientView.servicoRequerido?.length > 0 ? (
                  clientView.servicoRequerido.map((servico) => (
                    <div
                      key={servico.servico}
                      className={styles.servicosFavority}
                    >
              ...
              <div className={styles.estiloEndereco}>
                ...
                <span>{`${clientView.endereco.logradouro},
